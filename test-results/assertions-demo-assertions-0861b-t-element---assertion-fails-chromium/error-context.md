...
- Name: assertions-demo.spec.js >> assertions that FAIL (expected) >> non-existent element -> assertion fails
- Location: tests\assertions-demo.spec.js:41:3
...
Locator: getByRole('button', { name: 'This button does not exist' })
Expected: visible
Timeout: 5000ms
