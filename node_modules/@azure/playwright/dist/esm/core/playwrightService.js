...
const createAzurePlaywrightConfig = (baseConfig, options) => {
    ...
    return {
        use: {
            connectOptions: {
                wsEndpoint: getServiceWSEndpoint(playwrightServiceConfig.runId, playwrightServiceConfig.serviceOs, playwrightServiceConfig.apiVersion, playwrightServiceConfig.sourceType),
                headers: {
